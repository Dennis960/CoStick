...
class XboxControllerOverlay(QWidget):
    ...
    def init_controller(self, controller: Controller):
        # fmt: off
        controller.button.a.on_down(lambda button: self.button_a.set_pressed(button.pressed))
        controller.button.a.on_up(lambda button: self.button_a.set_pressed(button.pressed))
        controller.button.b.on_down(lambda button: self.button_b.set_pressed(button.pressed))
        controller.button.b.on_up(lambda button: self.button_b.set_pressed(button.pressed))
        controller.button.x.on_down(lambda button: self.button_x.set_pressed(button.pressed))
        controller.button.x.on_up(lambda button: self.button_x.set_pressed(button.pressed))
        controller.button.y.on_down(lambda button: self.button_y.set_pressed(button.pressed))
        controller.button.y.on_up(lambda button: self.button_y.set_pressed(button.pressed))
        controller.button.left.on_down(lambda button: self.dpad_left.set_pressed(button.pressed))
        controller.button.left.on_up(lambda button: self.dpad_left.set_pressed(button.pressed))
        controller.button.down.on_down(lambda button: self.dpad_down.set_pressed(button.pressed))
        controller.button.down.on_up(lambda button: self.dpad_down.set_pressed(button.pressed))
        controller.button.right.on_down(lambda button: self.dpad_right.set_pressed(button.pressed))
        controller.button.right.on_up(lambda button: self.dpad_right.set_pressed(button.pressed))
        controller.button.up.on_down(lambda button: self.dpad_up.set_pressed(button.pressed))
        controller.button.up.on_up(lambda button: self.dpad_up.set_pressed(button.pressed))
        controller.button.l.on_down(lambda button: self.left_shoulder_button.set_pressed(button.pressed))
        controller.button.l.on_up(lambda button: self.left_shoulder_button.set_pressed(button.pressed))
        controller.button.r.on_down(lambda button: self.right_shoulder_button.set_pressed(button.pressed))
        controller.button.r.on_up(lambda button: self.right_shoulder_button.set_pressed(button.pressed))
        controller.button.zl.on_down(lambda button: self.bottom_left_shoulder_button.set_pressed(button.pressed))
        controller.button.zl.on_up(lambda button: self.bottom_left_shoulder_button.set_pressed(button.pressed))
        controller.button.zr.on_down(lambda button: self.bottom_right_shoulder_button.set_pressed(button.pressed))
        controller.button.zr.on_up(lambda button: self.bottom_right_shoulder_button.set_pressed(button.pressed))
        controller.joystick.left.on_down(lambda button: self.left_joystick.set_pressed(button.pressed))
        controller.joystick.left.on_up(lambda button: self.left_joystick.set_pressed(button.pressed))
        controller.joystick.right.on_down(lambda button: self.right_joystick.set_pressed(button.pressed))
        controller.joystick.right.on_up(lambda button: self.right_joystick.set_pressed(button.pressed))
        controller.joystick.left.on_move(lambda joystick: self.left_joystick.move_to(joystick.x, joystick.y))
        controller.joystick.right.on_move(lambda joystick: self.right_joystick.move_to(joystick.x, joystick.y))
        # fmt: on
